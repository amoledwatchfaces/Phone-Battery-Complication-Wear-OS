...
class EventTimerComplicationService : SuspendingComplicationDataSourceService() {
    ...
    var icon = drawable.event_upcoming_24px
        ...
        return when (type) {
            ...
            ComplicationType.LONG_TEXT -> {
                LongTextComplicationData.Builder(
                    ...
                    .setMonochromaticImage(MonochromaticImage.Builder(image = Icon.createWithResource(this, drawable.event_upcoming_24px)).build())
    ...
    override suspend fun onComplicationRequest(request: ComplicationRequest): ComplicationData? {
        ...
        if (closestEvent != null){
           ...
           // Log.i("CalendarEventTimerComplication", "Scheduling complication update with delay: ${delay/60000}")
            ...
            icon = drawable.calendar_check_24px
        }
